        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.26 8.01h4.47V24H.26V8.01zM8.55 8.01h4.29v2.17h.06c.6-1.14 2.06-2.34 4.24-2.34 4.54 0 5.38 2.99 5.38 6.88V24h-4.47v-7.2c0-1.72-.03-3.94-2.4-3.94-2.4 0-2.77 1.87-2.77 3.8V24H8.55V8.01z" />
                </svg>
              </a>
              ...
              >
                <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.186a2.974 2.974 0 0 0-2.09-2.103C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.408.583A2.974 2.974 0 0 0 .502 6.186 31.23 31.23 0 0 0 0 11.75a31.23 31.23 0 0 0 .502 5.564 2.974 2.974 0 0 0 2.09 2.103C4.495 19.999 12 20 12 20s7.505 0 9.408-.583a2.974 2.974 0 0 0 2.09-2.103A31.23 31.23 0 0 0 24 11.75a31.23 31.23 0 0 0-.502-5.564zM9.75 15.02V8.48l6.25 3.27-6.25 3.27z" />
                </svg>
              </a>
            </div>
          </div>
